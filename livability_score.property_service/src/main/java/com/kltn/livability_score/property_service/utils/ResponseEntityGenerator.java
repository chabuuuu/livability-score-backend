...
import com.kltn.livability_score.property_service.model.base_format.response.ResponsePageableVO;
import com.kltn.livability_score.property_service.model.base_format.response.ResponseVO;
import com.kltn.livability_score.property_service.model.base_format.response.ResponseVOBuilder;
...
public class ResponseEntityGenerator<T> {
     ...
     */
    public static <T> ResponseEntity<ResponseVO<T>> pagingFormat(Page<?> body, RequestPageableVO request) {
